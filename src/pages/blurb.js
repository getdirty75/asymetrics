        ...
        <div class="tile">
          <div class="tile is-parent">
            <article class="tile is-child box">
              ...
              <div className="image">
                <img className="blurb_img"
                  src={malong}
                />
              </div>
              <p className="blurb_desc">Malong is a Globe-trotter, self-taught-out-of-a-backpack bedroom DJ, with an aggressive passion for percussion and bass-heavy music from every age and corner of the World.</p>
            </article>
          </div>
          <div class="tile is-parent">
            <article class="tile is-child box">
              ...
              <p className="blurb_desc">Lord Sandwich is a dionysian philosopher, hardcore vinyl crate-digger, music encyclopedia, and occasionally versatile singer.</p>
          ...
          <div class="tile is-parent">
           <article class="tile is-child box">
            ...
            <p className="blurb_desc">Ben is a musician and tech wizard, responsible for the stunningness of this website's modest endeavour, and overall coherence among chaotic inputs.</p>
